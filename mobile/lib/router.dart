...
import 'features/accommodations/screens/booking_screen.dart';
  ...
  return GoRouter(
    ...
    routes: [
            ...
            routes: [
              GoRoute(
                ...
                builder: (context, state) =>
                    TrailDetailScreen(trailId: state.pathParameters['id']!),
              ),
            ],
          ),
          GoRoute(
      ...
      GoRoute(
        ...
        routes: [
          GoRoute(
            path: 'book',
            builder: (context, state) =>
                BookingScreen(accommodationId: state.pathParameters['id']!),
          ),
        ],
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) =>
            PaymentInstructionsScreen(bookingId: state.pathParameters['id']!),
      ),
      GoRoute(
        path: '/bookings/:id/receipt',
        builder: (context, state) =>
            ReceiptUploadScreen(bookingId: state.pathParameters['id']!),
      ),

...
const services = [
  // ── ENTRANCE ──
  {
    ...
    category: 'entrance', priceKgs: 200, unit: 'perPerson', images: [], isActive: true,
  },
  {
    id: 's-entrance-child',
    ...
    category: 'entrance', priceKgs: 150, unit: 'perPerson', images: [], isActive: true,
  },
  {
    ...
    category: 'entrance', priceKgs: 800, unit: 'perVehicle', images: [], isActive: true,
  },
  {
    ...
    category: 'entrance', priceKgs: 600, unit: 'perPerson', images: [], isActive: true,
  },
  {
    ...
    category: 'entrance', priceKgs: 400, unit: 'perPerson', images: [], isActive: true,
  },
  ...
  // ── KHAN-TENIRI ──
  {
    ...
    category: 'hotel', priceKgs: 21500, unit: 'perNight', capacity: 4, venue: 'Khan-Teniri', images: [], isActive: true,
  },
  ...
  // ── HOTELS ──
  {
    ...
    category: 'hotel', priceKgs: 9000, unit: 'perNight', capacity: 2, venue: 'Ala-Archa Hotel', phone: '+996 701 551 026', images: [], isActive: true,
  },
  {
    id: 's-hotel-ala-archa-5-6',
    name: { en: 'Junior Suite #5–6', ru: 'Полулюкс №5–6', ky: 'Жарым люкс №5–6' },
    description: { en: 'Double room, breakfast included', ru: 'Двухместный, завтрак включён', ky: 'Эки кишилик, эртең мененки тамак менен' },
    category: 'hotel', priceKgs: 6000, unit: 'perNight', capacity: 2, venue: 'Ala-Archa Hotel', phone: '+996 701 551 026', images: [], isActive: true,
  },
  {
    ...
    category: 'hotel', priceKgs: 7000, unit: 'perNight', capacity: 4, venue: 'Ala-Archa Hotel', phone: '+996 701 551 026', images: [], isActive: true,
  },
  {
  ...
  },
  {
    ...
    description: { en: 'Double room, breakfast included', ru: 'Двухместный, завтрак включён', ky: 'Эки кишилик, эртең мененки тамак менен' },
    category: 'hotel', priceKgs: 7000, unit: 'perNight', capacity: 2, venue: 'Ak-Bata Hotel', phone: '+996 500 417 741', images: [], isActive: true,
  },
  {
    id: 's-hotel-akbata-suite',
    name: { en: 'Suite #1, #2, #7, #8', ru: 'Люкс №1, 2, 7, 8', ky: 'Люкс №1, 2, 7, 8' },
    description: { en: 'Double room, breakfast included', ru: 'Двухместный, завтрак включён', ky: 'Эки кишилик, эртең мененки тамак менен' },
    category: 'hotel', priceKgs: 5000, unit: 'perNight', capacity: 2, venue: 'Ak-Bata Hotel', phone: '+996 500 417 741', images: [], isActive: true,
  },

  // ── VENUE HALLS ──
  { id: 's-hall-conf-30', name: { en: 'Conference Hall (30 seats)', ru: 'Конференц-зал (30 мест)', ky: 'Конференц-зал (30 орун)' }, description: { en: 'First hour 2,000 KGS; each additional 1,000 KGS', ru: 'Первый час 2 000; далее 1 000 сом/час', ky: 'Биринчи саат 2 000; кийинкиси 1 000 сом' }, category: 'venue', priceKgs: 2000, unit: 'perHour', capacity: 30, images: [], isActive: true },
  { id: 's-hall-banquet-10', name: { en: 'Banquet Hall (10 seats)', ru: 'Банкетный зал (10 мест)', ky: 'Банкет залы (10 орун)' }, description: { en: 'First hour 500 KGS; each additional 250 KGS', ru: 'Первый час 500; далее 250 сом/час', ky: 'Биринчи саат 500; кийинкиси 250 сом' }, category: 'venue', priceKgs: 500, unit: 'perHour', capacity: 10, images: [], isActive: true },
  { id: 's-hall-banquet-30', name: { en: 'Banquet Hall (30 seats)', ru: 'Банкетный зал (30 мест)', ky: 'Банкет залы (30 орун)' }, description: { en: 'First hour 2,000 KGS; each additional 500 KGS', ru: 'Первый час 2 000; далее 500 сом/час', ky: 'Биринчи саат 2 000; кийинкиси 500 сом' }, category: 'venue', priceKgs: 2000, unit: 'perHour', capacity: 30, images: [], isActive: true },
  { id: 's-hall-fireplace', name: { en: 'Fireplace Hall (10 seats)', ru: 'Каминный зал (10 мест)', ky: 'Камин залы (10 орун)' }, description: { en: 'First hour 1,000 KGS; each additional 500 KGS', ru: 'Первый час 1 000; далее 500 сом/час', ky: 'Биринчи саат 1 000; кийинкиси 500 сом' }, category: 'venue', priceKgs: 1000, unit: 'perHour', capacity: 10, images: [], isActive: true },
  { id: 's-hall-yurt-national', name: { en: 'National Yurt (15 seats)', ru: 'Национальная юрта (15 мест)', ky: 'Улуттук боз үй (15 орун)' }, description: { en: 'First hour 1,000 KGS; each additional 500 KGS', ru: 'Первый час 1 000; далее 500 сом/час', ky: 'Биринчи саат 1 000; кийинкиси 500 сом' }, category: 'venue', priceKgs: 1000, unit: 'perHour', capacity: 15, images: [], isActive: true },
  { id: 's-hall-akbata-45', name: { en: 'Conference Hall (45 seats)', ru: 'Конференц-зал (45 мест)', ky: 'Конференц-зал (45 орун)' }, description: { en: 'Flat hourly rate', ru: 'Фиксированная ставка за час', ky: 'Бекитилген сааттык тариф' }, category: 'venue', priceKgs: 4000, unit: 'perHour', capacity: 45, venue: 'Ak-Bata', images: [], isActive: true },
  { id: 's-hall-akbata-70', name: { en: 'Conference Hall (70 seats)', ru: 'Конференц-зал (70 мест)', ky: 'Конференц-зал (70 орун)' }, description: { en: 'Flat hourly rate', ru: 'Фиксированная ставка за час', ky: 'Бекитилген сааттык тариф' }, category: 'venue', priceKgs: 5000, unit: 'perHour', capacity: 70, venue: 'Ak-Bata', images: [], isActive: true },

  // ── RECREATION ──
  { id: 's-rec-aframe', name: { en: 'A-Frame Cottage', ru: 'А-коттедж', ky: 'А-коттедж' }, description: { en: '4 guests, guests bring their own meals', ru: '4 гостя, еду гости приносят сами', ky: '4 коноктун тамагын өздөрү алып келет' }, category: 'recreation', priceKgs: 8850, unit: 'perNight', capacity: 4, phone: '+996 550 133 603', images: [], isActive: true },
  { id: 's-rec-forest-house', name: { en: 'House in the Forest', ru: '«Дом в лесу»', ky: '«Токойдогу үй»' }, description: { en: '16-person hall, bedroom, kitchen', ru: 'Зал на 16 мест, спальня, кухня', ky: '16 орундуу зал, уктоочу бөлмө, ашкана' }, category: 'recreation', priceKgs: 2500, unit: 'perNight', capacity: 16, images: [], isActive: true },
  { id: 's-rec-simple-yurt', name: { en: 'Simple Yurt', ru: 'Простая юрта', ky: 'Жөнөкөй боз үй' }, description: { en: 'Traditional yurt for rent', ru: 'Традиционная юрта в аренду', ky: 'Салттуу боз үй ижарага' }, category: 'recreation', priceKgs: 1000, unit: 'perNight', images: [], isActive: true },
  { id: 's-rec-summer-cottage', name: { en: 'Summer Cottages', ru: 'Летние коттеджи', ky: 'Жайкы коттедждер' }, description: { en: 'Per-room rate', ru: 'За каждый номер', ky: 'Ар бир номер үчүн' }, category: 'recreation', priceKgs: 6000, unit: 'perNight', images: [], isActive: true },
  { id: 's-rec-canopy', name: { en: 'Summer Canopy', ru: 'Летний навес', ky: 'Жайкы навес' }, description: { en: '6 hours, table service for 10', ru: '6 часов, стол на 10 человек', ky: '6 саат, 10 кишиге үстөл' }, category: 'recreation', priceKgs: 400, unit: 'perTable', capacity: 10, images: [], isActive: true },
  { id: 's-rec-botanik', name: { en: 'Botanik', ru: '«Ботаник»', ky: '«Ботаник»' }, description: { en: '16-person hall, bedroom, kitchen', ru: 'Зал на 16 мест, спальня, кухня', ky: '16 орундуу зал, уктоочу бөлмө, ашкана' }, category: 'recreation', priceKgs: 2000, unit: 'perNight', capacity: 16, images: [], isActive: true },
  { id: 's-rec-cafebar', name: { en: 'Cafe-Bars Adygene & Boyrok', ru: 'Кафе-бары «Адыгене» и «Бойрок»', ky: '«Адыгене» жана «Бойрок» кафе-барлары' }, description: { en: 'Per table, per day', ru: 'За стол, в день', ky: 'Бир үстөлгө, күнүнө' }, category: 'recreation', priceKgs: 400, unit: 'perTable', phone: '+996 702 150 976', images: [], isActive: true },
  { id: 's-rec-alplager', name: { en: 'Alplager Canteen', ru: 'Столовая «Альплагерь»', ky: '«Альплагерь» ашканасы' }, description: { en: 'Per table, per day', ru: 'За стол, в день', ky: 'Бир үстөлгө, күнүнө' }, category: 'recreation', priceKgs: 400, unit: 'perTable', images: [], isActive: true },
  { id: 's-rec-salkyn-tor', name: { en: 'Gazebo Salkyn-Tor (50 seats)', ru: 'Беседка «Салкын-Тор» (50 мест)', ky: '«Салкын-Тор» беседкасы (50 орун)' }, description: { en: '1,500 KGS/table; +1,000 each additional hour; 6,000 for 5+ hours', ru: '1 500 сом/стол; +1 000 сом/час; 6 000 сом за 5+ часов', ky: '1 500 сом/үстөл; +1 000 сом/саат; 6 000 сом 5+ саатка' }, category: 'recreation', priceKgs: 1500, unit: 'perTable', capacity: 50, images: [], isActive: true },

  // ── RENTALS / ACTIVITIES ──
  { id: 's-rent-sauna', name: { en: 'Sauna', ru: 'Сауна', ky: 'Сауна' }, description: { en: 'Per person, per hour', ru: 'С человека в час', ky: 'Бир кишиге, сааттык' }, category: 'rental', priceKgs: 200, unit: 'perHour', phone: '+996 999 380 280', images: [], isActive: true },
  { id: 's-rent-horse', name: { en: 'Horse Riding', ru: 'Конные прогулки', ky: 'Ат минүү' }, description: { en: 'Per horse, per hour', ru: 'За лошадь в час', ky: 'Бир атка, сааттык' }, category: 'rental', priceKgs: 400, unit: 'perHour', images: [], isActive: true },
  { id: 's-rent-skating', name: { en: 'Ice Skating', ru: 'Катание на коньках', ky: 'Коньки тебүү' }, description: { en: 'Per person, per hour', ru: 'С человека в час', ky: 'Бир кишиге, сааттык' }, category: 'rental', priceKgs: 100, unit: 'perHour', images: [], isActive: true },
  { id: 's-rent-guide', name: { en: 'Guide Services', ru: 'Услуги гида', ky: 'Гид кызматы' }, description: { en: 'Per hour', ru: 'За час', ky: 'Бир саатка' }, category: 'rental', priceKgs: 300, unit: 'perHour', images: [], isActive: true },
  { id: 's-rent-tapchan', name: { en: 'Tapchan', ru: 'Аренда тапчана', ky: 'Тапчан ижарасы' }, description: { en: 'Per hour', ru: 'За час', ky: 'Бир саатка' }, category: 'rental', priceKgs: 200, unit: 'perHour', images: [], isActive: true },

  // ── EXTRAS ──
  { id: 's-extra-museum-adult', name: { en: 'Museum Visit (adult)', ru: 'Посещение музея (взрослый)', ky: 'Музейге баруу (чоң киши)' }, description: { en: 'Per person', ru: 'С человека', ky: 'Бир кишиге' }, category: 'extra', priceKgs: 50, unit: 'perPerson', images: [], isActive: true },
  { id: 's-extra-museum-child', name: { en: 'Museum Visit (child under 12)', ru: 'Посещение музея (до 12)', ky: 'Музейге баруу (12 жашка чейин)' }, description: { en: 'Per child', ru: 'За ребёнка', ky: 'Бир балага' }, category: 'extra', priceKgs: 20, unit: 'perPerson', images: [], isActive: true },
  { id: 's-extra-dishes', name: { en: 'Dishes & Cutlery', ru: 'Посуда и приборы', ky: 'Идиш-аяк' }, description: { en: '4 hours, set for 10', ru: '4 часа, набор на 10 человек', ky: '4 саатка, 10 кишиге' }, category: 'extra', priceKgs: 250, unit: 'flat', images: [], isActive: true },
  { id: 's-extra-cauldron', name: { en: 'Cauldron', ru: 'Казан', ky: 'Казан' }, description: { en: '4 hours', ru: '4 часа', ky: '4 саатка' }, category: 'extra', priceKgs: 250, unit: 'flat', images: [], isActive: true },
  { id: 's-extra-grill', name: { en: 'Grill', ru: 'Мангал', ky: 'Мангал' }, description: { en: '4 hours', ru: '4 часа', ky: '4 саатка' }, category: 'extra', priceKgs: 200, unit: 'flat', images: [], isActive: true },
  { id: 's-extra-kitchen', name: { en: 'Kitchen Access', ru: 'Аренда кухни', ky: 'Ашкана ижарасы' }, description: { en: '4 hours of cooking access', ru: '4 часа, готовка', ky: '4 саат, тамак жасоо' }, category: 'extra', priceKgs: 2000, unit: 'flat', images: [], isActive: true },
  { id: 's-extra-cooking', name: { en: 'Cooking from Your Ingredients', ru: 'Готовка из продуктов гостя', ky: 'Коноктун азыктарынан тамак жасоо' }, description: { en: 'Per portion', ru: 'За порцию', ky: 'Бир порцияга' }, category: 'extra', priceKgs: 50, unit: 'perItem', images: [], isActive: true },
  { id: 's-extra-hearth', name: { en: 'Hearth with Cauldron', ru: 'Очаг с казаном', ky: 'Казан менен очок' }, description: { en: 'Per hour', ru: 'За час', ky: 'Бир саатка' }, category: 'extra', priceKgs: 100, unit: 'perHour', images: [], isActive: true },
  { id: 's-extra-storage', name: { en: 'Luggage Storage', ru: 'Камера хранения', ky: 'Жүк сактоочу' }, description: { en: 'Up to 20 kg, per day', ru: 'До 20 кг, в день', ky: '20 кгга чейин, күнүнө' }, category: 'extra', priceKgs: 200, unit: 'perDay', images: [], isActive: true },
  { id: 's-extra-tent', name: { en: 'Tent Setup', ru: 'Установка палатки', ky: 'Чатыр коюу' }, description: { en: 'Per day', ru: 'В день', ky: 'Күнүнө' }, category: 'extra', priceKgs: 200, unit: 'perDay', images: [], isActive: true },
  { id: 's-extra-yurt-setup', name: { en: 'Yurt Setup', ru: 'Установка юрты', ky: 'Боз үй тигүү' }, description: { en: 'Per day', ru: 'В день', ky: 'Күнүнө' }, category: 'extra', priceKgs: 200, unit: 'perDay', images: [], isActive: true },
...
const accommodations = [
  {
    ...
    includesGondola: true, images: [], rating: 4.8, reviewCount: 24,
  },
  {
    ...
    includesGondola: false, images: [], rating: 4.6, reviewCount: 18,
  },
  {
    name: 'Mountain Dome',
    type: 'dome',
    ...
    includesGondola: false, images: [], rating: 4.9, reviewCount: 31,
  },
  {
    ...
    includesGondola: false, images: [], rating: 4.7, reviewCount: 15,
  },
  {
    ...
    includesGondola: false, images: [], rating: 4.3, reviewCount: 42,
  },
];
